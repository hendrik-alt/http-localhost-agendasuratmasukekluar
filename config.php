...
define("SITE_NAME", "agendasuratmasukekluar");
...
define("APP_ID", "6f4a43316b454664986361fc0b5606e4");

// Application Default Color (Mostly Used By Mobile)
define("META_THEME_COLOR", "#FFFF00");
...
define("DB_PASSWORD", "");
define("DB_NAME", "db_Agenda_Surat");
...
define('USER_ID',(isset($_SESSION[APP_ID.'user_data']) ? $_SESSION[APP_ID.'user_data']['ussername'] : null ));
